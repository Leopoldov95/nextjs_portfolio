  ...
  return (
    <section className={`container ${active === name ? "active" : "hidden"}`}>
      ...
      <div className="pt-14 pb-20">
        <h4 className="uppercase text-[1.4rem] text-center pb-14 relative mobile:text-left">
          My Work Timeline
        </h4>
        ...
        <h4 className="uppercase pt-8 text-[1.4rem] text-center pb-14 relative before:content-[''] before:absolute before:left-1/2 before:w-[40%] before:h-[1px] before:top-0 before:bg-colorGrey5 before:-translate-x-1/2">
          Education
        </h4>
        <div className="gap-8 pb-12">
